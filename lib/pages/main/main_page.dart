      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(
            activeIcon: SvgPicture.asset(currentIndex == 0 ? Assets.images.calendarGreen : Assets.images.calendarUnsSelected),
          ...
          BottomNavigationBarItem(
            icon: SvgPicture.asset(
              ...
              colorFilter: ColorFilter.mode(currentIndex == 1 ? Color(0xff245D3A) : Color(0xff64748B), BlendMode.srcIn),
            ),
            label: "مناسباتي",
          ),
          BottomNavigationBarItem(
